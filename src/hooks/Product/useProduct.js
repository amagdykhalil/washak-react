...
export const useProduct = () => {
    ...
    // Fetch 
    const { data: productData, loading: productLoading, error } = useProductBySlug(id);
    const { data: relatedProducts, loading: loadingRelatedProducts } = useRelatedProducts(id);
