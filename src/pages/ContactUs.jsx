...
export default function ContactUsPage() {
  ...
  const { contactus_page_title = 'اتصل بنا', contactus_page_content = '<p>نحن هنا للرد على جميع استفساراتك</p>', contactus_page_form_status = 'yes', contactus_page_map_status = 'no', contactus_page_map_latitude = '', contactus_page_map_longitude = '', contactus_page_map_title = "Map", contactus_page_map_sub_title = "Store Map" } = contactData?.value || {};
          ...
          <div className='space-y-6'>
            ...
            {loading ? (
              ...
              <div className='bg-gray-100/30 p-1 rounded-md shadow-lg overflow-hidden border border-gray-200/60 text-center'>
                {contactus_page_map_title && <h2 className='text-2xl md:text-xl font-bold text-gray-800 mb-3'>{contactus_page_map_title}</h2>}
                {contactus_page_map_sub_title && <p className='text-gray-600 mb-8'>{contactus_page_map_sub_title}</p>}
