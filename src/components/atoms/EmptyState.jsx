...
export default function EmptyState({ href = '', name_href = '' , type_animation="empty" , message = 'لا توجد بيانات لعرضها', subtext = 'حاول تعديل الفلاتر أو تصفح قسم آخر', className = '' }) {
  return (
    <div className={`w-full text-center py-16 flex flex-col items-center justify-center text-gray-500 space-y-4 ${className}`}>
      <div className='w-[400px] h-fit '>
        <Lottie animationData={ type_animation == "empty" ? emptyAnimation : boxAnimation } loop={true} />
      </div>
