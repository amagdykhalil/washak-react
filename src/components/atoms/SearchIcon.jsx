...
export default function SearchIcon() {
  ...
  const filtered = query
    ...
    : ProductsData.products.slice(0, 10);
  ...
  return (
    <div className='relative inline-block'>
      <div
        className={`flex items-center gap-2 bg-gray-100 p-2 rounded-full transition-all duration-300 ${
          open ? 'w-64' : 'w-[55px]'
        } overflow-hidden`}
      >
        <div
          className={`flex-none flex items-center justify-center ${
            !open ? ' bg-gray-200/70 ' : 'text-white bg-red-500 '
